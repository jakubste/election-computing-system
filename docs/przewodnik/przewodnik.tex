...
się do zwycięskiego komitetu. Dla wyborów generowanych z rozkładu normalnego lub poprzez zaznaczanie 
punktów system również oferuje wypisanie nazw zwycięzców w dobrze widocznym panelu.

Ponadto system oferuje wykres zależności czasu wykonanania obliczeń od parametru $p$ i 
