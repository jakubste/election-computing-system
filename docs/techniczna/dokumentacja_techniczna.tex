...
Systemy $k-Borda$ i Chamberlina-Couranta są szczególnymi przypadkami zdefiniowanego powyżej systemu $\ell_p-Borda$:\\
Dla \, $p = 1$, \, $l_1$:
\begin{equation}
...
\subsection{Wpływ parametrów na wyniki osiągane przez algorytm}
