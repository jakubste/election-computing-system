...
zostać zaimportowana z odpowiednio sformatowanego pliku, wygenerowana losowo lub przez zaznaczenie 
punktów na płaszczyźnie.
Na wprowadzonych do systemu listach preferencji i ustalonej liczbie k wyborców użytkownik może 
...
Dodano rownież wykres zestawiający czasy obliczeń algorytmów w zależności od parametru $p$.
