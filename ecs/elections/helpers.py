from ecs.elections.exceptions import NumberOfVotesInconsistencyException, PreferenceOrderBeyondScopeException, \
    IncorrectVotesNumberUniqueVotesRelationException, NonPositiveNumberOfVotesException, \
    IncorrectPreferenceOrderException
from ecs.elections.exceptions import PreferenceOrderLengthException


def check_number_of_votes_consistency(voters_number_in_loop, voters_number_in_file_line):
    """
...
def check_vote_consistency(preference_order, candidates_number):
    """
...
def check_votes_number_unique_votes_relation(votes_number, unique_votes):
    """
